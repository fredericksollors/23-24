...
# Anzeigen der Zusammenfassung des Regressionsmodells
summary(reg1)
...
n_train <- sum(jtrain3$train, na.rm = TRUE)
n_train
...
# Lineare Regression zur Untersuchung des Einflusses von Weiterbildung und Arbeitslosigkeit 1975 auf Arbeitslosigkeit 1978
reg2 <- lm(unem78 ~ train + unem75, data = jtrain3)

# Ergebnisse von reg1 und reg2 nebeneinander anzeigen
...
# Datensatz für Personen, die 1975 arbeitslos waren
jtrain3_la <- jtrain3[jtrain3$unem75 == 1, ]

# Datensatz für Personen, die 1975 nicht arbeitslos waren
...
# Regression für Personen, die 1975 arbeitslos waren
reg_la <- lm(unem78 ~ train, data = jtrain3_la)

# Regression für Personen, die 1975 nicht arbeitslos waren
